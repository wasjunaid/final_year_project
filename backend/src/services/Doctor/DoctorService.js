...
const {
  validDoctorStatuses,
} = require("../../database/doctor/doctorTableQuery");
...
class DoctorService {
  ...
  static async getDoctorsForHospital(person_id, hospital_id) {
    ...
    try {
      const checkStaffExists =
        await HospitalStaffService.checkHospitalStaffExistsAgainstHospitalID(
          person_id,
          hospital_id
        );
      if (!checkStaffExists) {
        throw new AppError(
          "You are not authorized to view doctors for this hospital",
  ...
  static async updateDoctorStatus(person_id, doctor_id, status) {
    ...
    try {
      ...
      console.error(
        `Error updating doctor status: ${error.message} ${error.status}`
      );
      throw error;
    }
  }
  ...
  static async updateDoctorHospital(doctor_id, hospital_id) {
    ...
    try {
      ...
      console.error(
        `Error updating doctor hospital: ${error.message} ${error.status}`
      );
      throw error;
    }
  }
  ...
  static async removeDoctorFromHospital(doctor_id) {
    ...
    try {
      ...
      console.error(
        `Error removing doctor hospital: ${error.message} ${error.status}`
      );
      throw error;
    }
  }
  ...
  static async checkDoctorExists(doctor_id) {
    ...
    try {
      ...
      console.error(
        `Error checking doctor exists: ${error.message} ${error.status}`
      );
      throw error;
    }
  }
  ...
  static async checkDoctorExistsAgainstHospitalID(doctor_id, hospital_id) {
    ...
    try {
      ...
      console.error(
        `Error checking doctor exists against hospital id: ${error.message} ${error.status}`
      );
      throw error;
    }
  }
