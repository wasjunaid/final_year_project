...
const appointmentService = {
  ...
  async createDoctorFollowUp(appointmentId: number, payload: DoctorFollowUpPayload): Promise<ApiResponse<AppointmentDto>> {
    const resp = await apiClient.post<ApiResponse<AppointmentDto>>(`/appointment/doctor-follow-up/${appointmentId}`, payload);
    return resp.data;
  },

  async createPatientFollowUp(appointmentId: number, payload: DoctorFollowUpPayload): Promise<ApiResponse<AppointmentDto>> {
    const resp = await apiClient.post<ApiResponse<AppointmentDto>>(`/appointment/patient-follow-up/${appointmentId}`, payload);
    return resp.data;
  },
  ...
  async hospitalize(appointmentId: number): Promise<ApiResponse<any>> {
    const resp = await apiClient.put<ApiResponse<any>>(`/appointment/hospitalize/${appointmentId}`);
    return resp.data;
  },
