...
import { SystemAnalyticsDashboard } from '../systemAdmin/SystemAnalyticsDashboard';
import BlockchainHistoryPage from '../blockchainHistory/BlockchainHistoryPage';

const SystemSubAdminPortal: React.FC = () => {
  ...
  const adminSidebarConfig: SidebarConfig = {
    ...
    mainNavItems: [
      ...
      { icon: ClipboardList, label: 'Logs', route: 'logs' },
      ...
      default:
        return (
          <div className="flex items-center justify-center h-full">
            <h1 className="text-2xl font-bold">System Sub Admin Portal</h1>
          </div>
        )
    }
  };
...
export default SystemSubAdminPortal;
