...
export const DocumentDetailsView: React.FC<DocumentDetailsViewProps> = ({
  ...
  const resolvedDocumentId = (document.documentId || (document as any).document_id || '').toString();
  ...
  useEffect(() => {
    const loadDocument = async () => {
      ...
      try {
        ...
        const previewBlob = document.mimeType ? new Blob([blob], { type: document.mimeType }) : blob;
  ...
  }, [resolvedDocumentId, document.mimeType]);
    ...
    <div className="bg-white dark:bg-[#2d2d2d] rounded-xl shadow-md border border-gray-200 dark:border-[#404040]">
      ...
      <div className="p-6 border-b border-gray-200 dark:border-[#404040]">
        <div className="flex items-center justify-between gap-3 mb-2">
          ...
          <button
            onClick={() => onDownload(resolvedDocumentId, document.originalName)}
