...
import SystemSubAdminPortal from './pages/portals/SystemSubAdminPortal';
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route
          path={`${ROUTES.SYSTEM_SUB_ADMIN_PORTAL}/*`}
          element={
            <ProtectedRoute allowedRoles={[ROLES.SYSTEM_ADMIN, ROLES.SYSTEM_SUB_ADMIN]}>
              <SystemSubAdminPortal />
            </ProtectedRoute>
          }
        />
        ...
        <Route
          ...
          element={
            <ProtectedRoute allowedRoles={[ROLES.HOSPITAL_ADMIN, ROLES.HOSPITAL_SUB_ADMIN]}>
              <HospitalAdminPortal />
            </ProtectedRoute>
          }
        />
