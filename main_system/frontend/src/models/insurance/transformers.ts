...
export const toPatientInsuranceModel = (dto: PatientInsuranceDto): PatientInsuranceModel => {
  return {
    ...
    auto_renewal_enabled: dto.auto_renewal_enabled,
    is_active: dto.is_active,
    effective_date: dto.effective_date,
    expiration_date: dto.expiration_date,
    last_renewed_at: dto.last_renewed_at,
    deactivated_at: dto.deactivated_at,
    deactivation_reason: dto.deactivation_reason,
    created_at: dto.created_at,
    updated_at: dto.updated_at,
  };
};
