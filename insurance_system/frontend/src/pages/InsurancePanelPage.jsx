    ...
    <div className="min-h-screen bg-gray-50 dark:bg-[#1a1a1a]">
      ...
      <main className="pt-20 md:pl-[17rem] px-4 pb-4 md:px-6 md:pb-6 space-y-4">
        <div className="bg-white dark:bg-[#2d2d2d] rounded-xl border border-gray-200 dark:border-[#404040] p-5 flex items-center justify-between gap-3">
          ...
          <Button variant="primary" onClick={() => setOpenDialog(true)}><Plus size={16} /> Add Hospital</Button>
        </div>
                ...
                <tbody>
                  {panelList.length === 0 ? (
                    ...
                    paginatedPanelList.map((panel) => (
                      <tr key={panel.insurance_panel_list_id} className="border-t border-gray-100 dark:border-[#3a3a3a]">
