        ...
        <div className="p-6 space-y-4">
          ...
          {bill.isClaim && bill.claimStatus === ClaimStatus.PENDING && (
            <Alert
              type="info"
              title="Claim Pending"
              message="Your insurance claim is still pending. You can choose to pay now or wait for claim approval."
              onClose={() => {}}
            />
          )}
          ...
          <div className="flex justify-end gap-3 pt-4 border-t border-gray-200 dark:border-dark-border">
            ...
            <Button
              ...
              disabled={paymentProcessing || bill.isPaid || !walletAddress}
