...
import type { CreatePatientInsuranceRequest } from "../../../models/PatientInsurance";
...
function CreatePatientInsuranceModal({
  ...
  const validateForm = (): boolean => {
    ...
    } else if (existingInsurances.some(i => i.insurance_number === formData.insurance_number)) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const requestData: CreatePatientInsuranceRequest = {
    ...
    const success = await create(requestData);
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-md">
              <p className="text-blue-800 text-sm">
                ...
                insurance card exactly. If you have multiple insurances, you can
                set one as primary.
              </p>
            </div>
          </form>
